...
*/}}
{{- define "keycloak-operator-crds.fullname" -}}
...
*/}}
{{- define "keycloak-operator-crds.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "keycloak-operator-crds.fullname" .) .Values.serviceAccount.name }}
{{- else }}
